    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header py-1 border-transparent" style="background-color: rgba(0, 0, 0, 0.03);">
                <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa-solid fa-car-tunnel"></i> Nuevo usuario</h5>
                ...
                <div class="row contenedorFormularioRegistrar">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control form-control-sm" id="apellidoPaterno" name="apellidoPaterno">
                        </div>
                    </div>
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control form-control-sm" id="apellidoMaterno" name="apellidoMaterno">
                        </div>
                    </div>
                    <div class="form-group col-lg-6">
